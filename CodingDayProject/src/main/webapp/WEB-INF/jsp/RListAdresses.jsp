...
<layout:extends name="layout.jsp">
	<layout:put block="content" type="REPLACE">
		...
		<div class="main-card mb-3 card">
			<div class="card-body">
				<h5 class="card-title">Liste des adresses non associées</h5>
				<div class="tab">
					...
					<tbody>
						<c:forEach var="a" items="${adresse}">
							<tr>
								...
								<td> <button class="mb-2 mr-2 btn btn-primary" onclick="window.location.href='/basic/AssocierAdresse?id=${a.id}'">Associer</button>
