...
<input type="text" name="prenom" id="prenom" oninput="myFunction()" placeholder="Prenom" />
<input type="text" name="prenom" id="prenom" oninput="myFunction()" placeholder="Nom" />
...
<button class="btn_sign_up" id="mybutton" type="submit">SIGN UP</button>
</form>
